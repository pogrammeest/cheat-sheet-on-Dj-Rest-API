...
'''
Что-то что мы уже заменили, правда я не помню что...
'''
...
#     permission_classes = [IsOwner]  # [permissions.IsAuthenticatedOrReadOnly, IsOwner]
#     queryset = Snippet.objects.all()
#     serializer_class = SnippetSerializer


'''
Такие закомментированные миксины используются для получение этого лаконичного кода 
'''
...
'''
v0.2 Декоратор @api_view для работы с представлениями, основанными на функциях.
'''
# @api_view(['GET', 'POST'])
